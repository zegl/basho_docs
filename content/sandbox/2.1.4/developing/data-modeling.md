...
operations, use of Riak features including [Data Types](/riak/kv/2.1.4/developing/data-types/),
[MapReduce](/riak/kv/2.1.4/developing/usage/mapreduce/), [Search](/riak/kv/2.1.4/developing/usage/search/),
[secondary indexes (2i)](/riak/kv/2.1.4/developing/usage/secondary-indexes/) and more. This guide
...
* [Session Storage](/riak/kv/2.1.4/developing/data-modeling/#session-storage)
* [Serving Advertisements](/riak/kv/2.1.4/developing/data-modeling/#serving-advertisements)
* [Log Data](/riak/kv/2.1.4/developing/data-modeling/#log-data)
* [Sensor Data](/riak/kv/2.1.4/developing/data-modeling/#sensor-data)
...
* [User Accounts](/riak/kv/2.1.4/developing/data-modeling/#user-accounts)
* [User Settings and Preferences](/riak/kv/2.1.4/developing/data-modeling/#user-settings-and-preferences)
* [User Events and Timelines](/riak/kv/2.1.4/developing/data-modeling/#user-events-and-timelines)
* [Articles, Blog Posts, and Other Content](/riak/kv/2.1.4/developing/data-modeling/#articles-blog-posts-and-other-content)
...
session expiry. Riak's [MapReduce](/riak/kv/2.1.4/developing/usage/mapreduce/) system can also be
...
address), [using secondary indexes](/riak/kv/2.1.4/developing/usage/secondary-indexes/) can provide an easy solution.
...
for analysis [using MapReduce](/riak/kv/2.1.4/developing/usage/mapreduce) or as a storage system used in
...
[secondary index](/riak/kv/2.1.4/developing/usage/secondary-indexes/), which would allow you to
perform queries on specific time interval ranges or to perform
[MapReduce](/riak/kv/2.1.4/developing/usage/mapreduce/) queries against the indexes.
...
username as a [secondary index](/riak/kv/2.1.4/developing/usage/secondary-indexes/) for efficient
lookup.
