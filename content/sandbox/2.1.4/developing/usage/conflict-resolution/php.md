...
aliases:
  ...
  - /riak/kv/2.1.4/dev/using/conflict-resolution/php
---
...
[bucket type](/riak/kv/2.1.4/developing/usage/bucket-types) `siblings`, and for this bucket type
...
the official PHP client library, in the [Developing with Riak KV: Usage](/riak/kv/2.1.4/developing/usage) section.
