...
on specifying trusted CIDRs can be found in [Trust-based Authentication](/riak/kv/2.1.4/using/security/managing-sources/#trust-based-authentication).
