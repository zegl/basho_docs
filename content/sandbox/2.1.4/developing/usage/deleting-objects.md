...
you first fetch the [causal context](/riak/kv/2.1.4/learn/concepts/causal-context) of the object prior to updating.
This can be done by setting the `deletedvclock` parameter to `true` as
part of the [fetch operation](/riak/kv/2.1.4/developing/api/protocol-buffers/fetch-object). This can also be done
