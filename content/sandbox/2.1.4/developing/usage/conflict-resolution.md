...
[sibling explosion](/riak/kv/2.1.4/using/performance/latency-reduction#siblings), which can
...
the entire node. Other issues include [increased cluster latency](/riak/kv/2.1.4/using/performance/latency-reduction) as the object is replicated and out-of-memory errors.
