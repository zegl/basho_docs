...
aliases:
  ...
  - /riak/kv/2.1.4/dev/references/protocol-buffers/reset-bucket-props
---
...
[bucket type](/riak/kv/2.1.4/developing/usage/bucket-types) using the `type` value. If you do not
