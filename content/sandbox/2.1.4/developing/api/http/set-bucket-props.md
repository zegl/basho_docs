...
aliases:
  ...
  - /riak/kv/2.1.4/dev/references/http/set-bucket-props
---
...
clock) when writing
* `precommit` - [precommit hooks](/riak/kv/2.1.4/developing/usage/commit-hooks)
* `postcommit` - [postcommit hooks](/riak/kv/2.1.4/developing/usage/commit-hooks)
